...
<script src="<@s.url'/js/verify/index-construct.js'/>" type="text/javascript"></script>
<script id="proListTpl" type="text/html">
    ...
    <tr>
        ...
        <td>
            <a href="javascript:;" data-id="{{ item.proid }}" class="layui-btn layui-btn-normal layui-btn-mini proview"><i class="fa fa-list-alt"></i>&nbsp;&nbsp;详细</a>
            {{#  if(item.changed == 0){ }}
                {{#  if(item.prostep == 10){ }}
                <a href="javascript:;" data-id="{{ item.proid }}" class="layui-btn layui-btn-mini prostart"><i class="fa fa-external-link"></i>&nbsp;&nbsp;项目申请开工</a>
                {{#  } }}
                {{#  if(item.prostep == 11){ }}
                <a href="javascript:;" data-id="{{ item.proid }}" class="layui-btn layui-btn-mini constructLog"><i class="fa fa-upload"></i>&nbsp;&nbsp;施工日志上传</a>
                {{#  } }}
            {{#  } }}
        </td>
    </tr>
...
<script id="uploadTpl" type="text/html">
        <div class="layui-field-box">
            <a href="javascript:void(0);"  class="layui-btn layui-btn-mini file" id="uploadArea"><i class="fa fa-upload">&nbsp;</i>上传资料
